...
public:
    CRegTestParams() {
        ...
        consensus.BIP34Height = 100000000; // BIP34 has not activated on regtest
        consensus.BIP34Hash = uint256();
        consensus.BIP65Height = 1351; // BIP65 activated on regtest
        consensus.BIP66Height = 1251; // BIP66 activated on regtest
